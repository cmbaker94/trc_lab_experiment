...
% sprd = [30];% 40 20 40];%[0, 20, 30, 40, 0, 10, 20, 30, 40, 40, 40, 20, 40];
% Hs = [0.25 0.3 0.3];% 0.2 0.3 0.3 0.3];%[0.3, 0.3, 0.3, 0.3, 0.25, 0.25, 0.25, 0.25, 0.25, 0.2, 0.3, 0.3, 0.3]; 
% Tp =[2 2 2];% 2 2 3 3];%[2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 3, 3];
% h = [1.07 1.07 1.07];% 1.07 1.00 1.07 1.07];%[1.07, 1.07, 1.07, 1.07, 1.07, 1.07, 1.07, 1.07, 1.07, 1.07, 1.00, 1.07, 1.07];
...
% 
% % % % % threshold stereo
gamma = 0.45;%0.7%0.6;%0.6 % image threshold
minarea = 200;%800 % min area of object
samprate = 8; %Hz
pltflag = 0;
ixlim=[26.5 31.5];%25
iylim = [-14 14];
...
% % 
% % % % % rectify images for crest length identifiction
idxdy=0.05;
ixlim=[25 31.5];%25
iylim=[-14 14];
imlen=0;
