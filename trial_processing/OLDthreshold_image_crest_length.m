function threshold_image_crest_length_nosidewalls(Tinfo,thresh,minarea,samprate,pltflag,ixlim,iylim,idxdy)% This code will plot rectified images using code from
...
for i = 1:size(IR,3)/imfreq
    ...
    Irbw = smoothdata(Irbw,1,'movmedian',[4 4],'omitnan');
