...
for it = 1:10000
    isel = randperm(length(XL(:)),instnum);
    for il = 1:instnum
...
Sname1 = [Tinfo.figfolder,'dirspec_camera_regx',num2str(round(xlid(1))),'_',num2str(round(xlid(end))),'_regyneg',num2str(abs(round(ylid(1)))),'_',num2str(round(ylid(end))),'_dx',num2str(dx*100),'_dy',num2str(dy*100),'_filt_inst',num2str(instnum),'_iter',num2str(iternum)];
print(Sname1,'-dpng')
