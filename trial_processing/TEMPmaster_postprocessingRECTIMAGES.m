...
sprd = [30, 40, 0, 10, 20, 30, 40]%, 40, 40, 20, 40];%[30,  40];%
Hs = [0.3, 0.3, 0.25, 0.25, 0.25, 0.25, 0.25]%, 0.2, 0.3, 0.3, 0.3]; %[0.25, 0.25];%
Tp = [2, 2, 2, 2, 2, 2, 2, 2, 2, 3, 3];
h = [1.07, 1.07, 1.07, 1.07, 1.07, 1.07, 1.07, 1.07, 1.00, 1.07, 1.07];
...
ixlim=[18 35];%[18 35];
iylim=[-14 14];
imlen=0; %1 if rectify all trial
rectify_images_stereo(Tinfo,idxdy,ixlim,iylim,imlen)
