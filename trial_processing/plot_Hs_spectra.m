function plot_Hs_spectra(Tinfo)
...
%         load([Tinfo.savefolder,'\stereo_Hs_spectra.mat'], 'cam');
        ...
        hold on
        plot(spec.press.f,spec.press.See,'r','LineWidth',2)
        ...
        hold on
        plot(spec.press.f,spec.press.See_yavg,'r','LineWidth',2)
        plot(spec.cam.f,spec.cam.See_yavg,'b','LineWidth',2)
        plot(spec.lidar.f,spec.lidar.See_yavg,'Color',[0 0.5 0],'LineWidth',2)
        ...
        fill([spec.press.f(inotnan); flipud(spec.press.f(inotnan))],[spec.press.See_yavg(1,inotnan)+spec.press.See_ystd(1,inotnan) fliplr(spec.press.See_yavg(1,inotnan)-spec.press.See_ystd(1,inotnan))],'r','LineStyle','none')
        inotnan = spec.wg.f<5;
        fill([spec.wg.f(inotnan); flipud(spec.wg.f(inotnan))],[spec.wg.See_yavg(1,inotnan)+spec.wg.See_ystd(1,inotnan) fliplr(spec.wg.See_yavg(1,inotnan)-spec.wg.See_ystd(1,inotnan))],[0.5 0.5 0.5],'LineStyle','none')
        fill([spec.cam.f; flipud(spec.cam.f)],[spec.cam.See_yavg+spec.cam.See_ystd; flipud(spec.cam.See_yavg-spec.cam.See_ystd)],'b','LineStyle','none')
        fill([spec.lidar.f; flipud(spec.lidar.f)],[spec.lidar.See_yavg+spec.lidar.See_ystd; flipud(spec.lidar.See_yavg-spec.lidar.See_ystd)],[0 0.5 0],'LineStyle','none')
        alpha(0.2)
...
%% store text
fnsub = 'model_data_comp\';
eval(['!mkdir ',Tinfo.savefolder,fnsub])
fnx = [Tinfo.savefolder,fnsub,'cam_xp'];
writematrix(cam.x,fnx)
fny = [Tinfo.savefolder,fnsub,'cam_yp'];
writematrix(cam.y,fny)
fnhs = [Tinfo.savefolder,fnsub,'cam_Hs'];
writematrix(cam.Hs,fnhs)
fntp = [Tinfo.savefolder,fnsub,'cam_Tp'];
writematrix(cam.Tp,fntp)

fnx = [Tinfo.savefolder,fnsub,'lidar_xp'];
writematrix(lidar.x,fnx)
fny = [Tinfo.savefolder,fnsub,'lidar_yp'];
writematrix(lidar.y,fny)
fnhs = [Tinfo.savefolder,fnsub,'lidar_Hs'];
writematrix(lidar.Hs,fnhs)
fntp = [Tinfo.savefolder,fnsub,'lidar_Tp'];
writematrix(lidar.Tp,fntp)
