...
for ispreads in range(len(Tspreads)):
    ...
    fpath = campath + 'cam_grid_xy_' + fprocinfo + '.csv' #_5cm
    ...
    del itnum, label, campath, loc2calc, r, rlabels, Savg, SMavg, SMcam_sz, SMout, spread, Ssum, stdx, stdy, stdyt, stdxt, theta, Tp, values, zeniths
