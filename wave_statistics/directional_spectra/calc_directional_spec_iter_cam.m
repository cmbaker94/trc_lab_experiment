...
freqs = Smout.freqs;
if Tinfo.filt == 1
    specsave = [Tinfo.savefolder,'dirspec_cam_regx',num2str(round(xlid(1))),'_',num2str(round(xlid(end))),'_regyneg',num2str(abs(round(ylid(1)))),'_',num2str(round(ylid(end))),'_dx',num2str(dx*100),'_dy',num2str(dy*100),'_filt_inst',num2str(instnum),'_iter',num2str(iternum)];
end
