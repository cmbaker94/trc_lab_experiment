...
figpath = 'E:\\figures\\wave_statistic\\directional\\' + date + '\\'
locpath = 'E:\\data\\processed\\insitu\\'
ffaddition = 'allinst'
...
puvpath = path + 'data\\processed\\insitu\\' + Tinfo['insitu'] + '\\'
dname = 'PUV_p11.csv'
...
campath = path + 'data\\processed\\cameras\\TRM-' + Tinfo['camera'] + '\\frames_' + Tinfo['frames'] + '\\'
